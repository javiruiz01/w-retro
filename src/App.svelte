...
<main class="main h-full p-12">
            ...
            <div
                ...
                <div class="relative" class:hidden={textareaToShow !== idx}>
                  ...
                  <button
                    ...
                    <svg
                      ...
                      stroke-width="2"
                      viewBox="0 0 24 24"
                      class=" w-4 h-4 stroke-current text-green-500
                      cursor-pointer">
                      <path
                        d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0
                        0118 0z" />
                    </svg>
                  </button>
                </div>
              ...
              <div class="mt-2">
                {#each comments as element}
                  <div
                    class="mt-2 text-gray-800 py-2 px-4 rounded h-auto w-full
                    flex items-center border border-solid border-gray-400">
                    {element.text}
                  </div>
                {/each}
              </div>
  ...
  <button
    ...
    <svg
      ...
      stroke-width="2"
      viewBox="0 0 24 24"
      class="w-12 h-12 stroke-current text-teal-700">
